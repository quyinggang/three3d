import{g as y,O as z,ad as T,E as P,af as b,aE as I,aW as g,aa as L,u as N,ag as X}from"./three.module-8f39f104.js";import{_ as B,r as w,o as D,a as q,b as F,c as V,d as O}from"./index-5458cf76.js";const H={__name:"MouseControl",setup(G){const v=w(null),u=w(null),E=()=>new T,C=()=>new P(-1,1,1,-1,-1,1),M=(o,t,n)=>{const e=new b({canvas:o,antialias:!0});return e.setSize(t,n),e.setPixelRatio(window.devicePixelRatio),e},k=()=>{const o=`
    void main() {
