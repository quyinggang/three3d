import{O as M,ad as k,z as D,af as P,aE as x,C as o,q as p,u as _,aa as w}from"./three.module-8f39f104.js";import{O as A}from"./OrbitControls-8206acf3.js";import{_ as B,r as h,o as O,a as G,b as L,c as W,d as j}from"./index-639cdcb3.js";const q={__name:"UVShader",setup(z){let c=null;const d=h(null),l=h(null),F=()=>new k,y=n=>{const e=new D(45,n,1,1e3);return e.position.set(0,0,6),e.lookAt(0,0,0),e},C=(n,e,t)=>{const a=new P({canvas:n,antialias:!0});return a.setSize(e,t),a.setPixelRatio(window.devicePixelRatio),a},V=(n,e)=>{const t=new A(n,e);return t.minDistance=2,t.maxDistance=40,t},U=()=>{const n=`
      varying vec2 vUV;
