import{O as A,ad as D,z as L,af as O,aE as m,C as i,u as l,ah as v,q as j,ag as z}from"./three.module-8f39f104.js";import{O as G}from"./OrbitControls-8206acf3.js";import{_ as I,r as x,o as W,a as q,b as H,c as J,d as K}from"./index-b85de818.js";const Q={__name:"RiseShader",setup(X){let u=null;const d=x(null),f=x(null),F=()=>new D,T=n=>{const e=new L(45,n,1,1e3);return e.position.set(2,4,8),e.lookAt(0,0,0),e},R=(n,e,o)=>{const t=new O({canvas:n,antialias:!0});return t.setSize(e,o),t.setPixelRatio(window.devicePixelRatio),t},M=(n,e)=>{const o=new G(n,e);return o.enableDamping=!0,o.minDistance=1,o.maxDistance=300,o.minPolarAngle=Math.PI/4,o.maxPolarAngle=Math.PI/2*.96,o},S=()=>{const n=`
      uniform float uTime;
