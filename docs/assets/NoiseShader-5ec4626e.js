import{O as G,ad as B,z as W,af as L,aE as i,C as a,u as c,aa as s,ag as O}from"./three.module-8f39f104.js";import{_ as q,r as y,o as H,a as I,b as J,c as K,d as Q}from"./index-f2840deb.js";const X={__name:"NoiseShader",setup(Y){let d=null;const u=y(null),f=y(null),C=()=>new B,_=t=>{const o=new W(45,t,1,1e3);return o.position.set(0,0,6),o.lookAt(0,0,0),o},V=(t,o,r)=>{const e=new L({canvas:t,antialias:!0});return e.setSize(o,r),e.setPixelRatio(window.devicePixelRatio),e},F=()=>{const t=`
      varying vec2 vUV;
