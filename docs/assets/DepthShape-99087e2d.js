import{g as x,O as P,ad as M,E as z,af as A,aE as S,aW as h,aa as T,u as k,ag as B}from"./three.module-8f39f104.js";import{_ as D,r as b,o as F,a as G,b as I,c as O,d as W}from"./index-f7a3d314.js";const Y={__name:"DepthShape",setup(X){const l=b(null),u=b(null),w=()=>new M,_=()=>new z(-1,1,1,-1,-1,1),V=(n,c,r)=>{const e=new A({canvas:n,antialias:!0});return e.setSize(c,r),e.setPixelRatio(window.devicePixelRatio),e},y=()=>{const n=`
    void main() {
