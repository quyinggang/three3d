import{g as y,O as P,ad as T,E as z,af as I,aE as N,aW as x,aa as L,u as D,ag as F}from"./three.module-b483cf05.js";import{_ as O,r as w,o as V,a as X,b,c as B,d as H}from"./index-e2cfa11a.js";const G={__name:"RayMarching",setup(W){const v=w(null),f=w(null),E=()=>new T,M=()=>new z(-1,1,1,-1,-1,1),R=(o,t,n)=>{const e=new I({canvas:o,antialias:!0});return e.setSize(t,n),e.setPixelRatio(window.devicePixelRatio),e},k=()=>{const o=`
    void main() {
