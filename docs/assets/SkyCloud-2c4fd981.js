import{g as _,O as R,ad as T,E as b,af as L,aE as P,aW as k,aa as D,u as I,ag as N}from"./three.module-8787a522.js";import{_ as B,r as h,o as X,a as q,b as F,c as V,d as G}from"./index-2f68f5e3.js";const O={__name:"SkyCloud",setup(W){const m=h(null),p=h(null),g=()=>new T,M=()=>new b(-1,1,1,-1,-1,1),C=(o,t,n)=>{const e=new L({canvas:o,antialias:!0});return e.setSize(t,n),e.setPixelRatio(window.devicePixelRatio),e},E=()=>{const o=`
    void main() {
