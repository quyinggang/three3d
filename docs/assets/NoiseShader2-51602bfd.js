import{O as b,ad as j,C as c,z as k,af as F,aw as R,aE as w,u as p,aa as N}from"./three.module-8787a522.js";import{O as A}from"./OrbitControls-8109a5ff.js";import{_ as B,r as h,o as O,a as L,b as T,c as V,d as W}from"./index-1a0b05a6.js";const I={__name:"NoiseShader2",setup(q){let i=null;const d=h(null),l=h(null),_=()=>{const e=new j;return e.background=new c(12575709),e},y=e=>{const t=new k(45,e,1,1e4);return t.position.set(6,10,20),t.lookAt(0,0,0),t},g=(e,t,o)=>{const n=new F({canvas:e,antialias:!0});return n.setSize(t,o),n.setPixelRatio(window.devicePixelRatio),n},C=(e,t)=>new A(e,t),M=()=>{const e=new R(1,32,32),t=new w({uniforms:{iColor:{value:new c("#162a40")}},vertexShader:`
      vec3 random3(vec3 c) {
