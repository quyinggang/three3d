import{O as j,ad as A,z as G,af as I,aE as a,C as i,u as v,aa as x,ag as L}from"./three.module-8f39f104.js";import{_ as W,r as g,o as O,a as D,b as H,c as J,d as K}from"./index-f2840deb.js";const Q={__name:"FBMShader",setup(X){let l=null;const u=g(null),f=g(null),C=()=>new A,w=t=>{const o=new G(45,t,1,1e3);return o.position.set(0,0,6),o.lookAt(0,0,0),o},F=(t,o,c)=>{const e=new I({canvas:t,antialias:!0});return e.setSize(o,c),e.setPixelRatio(window.devicePixelRatio),e},_=()=>{const t=`
      varying vec2 vUV;
