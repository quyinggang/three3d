import{O as D,ad as M,z,af as k,G as x,ar as G,D as H,o as I,v as O,as as U,C as l,ag as W}from"./three.module-8f39f104.js";import{O as X}from"./OrbitControls-8206acf3.js";import{F as q}from"./FBXLoader-0e2d8373.js";import{_ as V,r as w,o as Y,a as $,b as j,c as J,d as K}from"./index-d7540ef8.js";const Q={__name:"CityEffect",setup(Z){let v=null;const g=w(null),S=w(null),C=()=>new M,y=e=>{const o=new z(45,e,1,1e4);return o.position.set(0,50,1e3),o.lookAt(0,0,0),o},T=(e,o,t)=>{const a=new k({canvas:e,antialias:!0});return a.setSize(o,t),a.setPixelRatio(window.devicePixelRatio),a},P=(e,o)=>{const t=new X(e,o);return t.enableDamping=!0,t.minDistance=300,t.maxDistance=6e3,t.minPolarAngle=Math.PI/4,t.maxPolarAngle=Math.PI/2*.96,t},E=()=>{const e=new x,o=new G(11382189),t=new H(16777215,.5);return t.position.set(600,600,0),e.add(o),e.add(t),e},R=e=>{new q().load("/src/assets/models/shanghai.FBX",t=>{e&&e(t)})},m=[],h=e=>{e.uniforms.uProgress={value:0},e.vertexShader=`
  ...
  `,e.vertexShader=e.vertexShader.replace("#include <begin_vertex>",`
    ...
    `),m.push(o=>{e.uniforms.uSpreadTime.value=o*200})},F=e=>{e.uniforms.uSweepTime={value:0},e.uniforms.uSweepColor={value:new l("#00FFFF")},e.vertexShader=e.vertexShader.replace("#include <common>",`
      #include <common>
    ...
    `),m.push(o=>{e.uniforms.uSweepTime.value=o*160})},A={CITY_UNTRIANGULATED:(e,o)=>{const{geometry:t,position:a,material:n}=e,d=new I({color:"#2685fe"}),i=new O(new U(t,1),d);i.position.copy(a),i.rotateX(-Math.PI/2),o.add(i),n.onBeforeCompile=s=>{n.color=new l("#0e233d"),n.transparent=!0,n.opacity=.9,h(s),b(s),L(s),F(s)},d.onBeforeCompile=s=>{h(s)}},LANDMASS:e=>{const o=e.material;o.color=new l("#040912"),o.transparent=!0,o.opacity=.8},ROADS:e=>{const o=e.material;o.color=new l("#292e4c")}};return Y(()=>{const e=g.value,o=S.value,t=o.clientWidth,a=o.clientHeight,n=C(),d=y(t/a),i=T(e,t,a),s=P(d,i.domElement),B=E();n.add(B),R(c=>{const r=new x;c.children.forEach(u=>{const f=u.clone(),p=A[f.name];p&&p(f,r),r.add(f)}),n.add(r)});const N=new W,_=()=>{const c=N.getElapsedTime();m.forEach(r=>{r&&r(c*.5)}),s.update(),i.render(n,d),v=window.requestAnimationFrame(_)};_(),$(()=>{i.dispose(),i.forceContextLoss(),n.traverse(c=>{if(c instanceof D){const{geometry:r,material:u}=c;r&&r.dispose();const f=Array.isArray(u)?u:[u];for(const p of f)p&&p.dispose()}}),window.cancelAnimationFrame(v)})}),(e,o)=>(j(),J("div",{ref_key:"containerElementRef",ref:S,class:"container"},[K("canvas",{ref_key:"canvasElementRef",ref:g},null,512)],512))}},re=V(Q,[["__scopeId","data-v-56924961"]]);export{re as default};
