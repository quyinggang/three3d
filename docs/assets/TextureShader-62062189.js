import{O as L,ad as B,z as O,af as F,b9 as G,aE as y,q as W,u as S,aa as j,g as c,ap as q,aC as z,h as H,R,V as N,ag as J}from"./three.module-8787a522.js";import{O as K}from"./OrbitControls-8109a5ff.js";import{a as Q}from"./arrow-ce0c96dc.js";import{_ as X,r as V,o as Y,a as Z,b as $,c as ee,d as m,u as te,p as ne,e as oe}from"./index-2f68f5e3.js";const ae=""+new URL("gm-8dde0536.mp4",import.meta.url).href;const re=i=>(ne("data-v-99d8e0bc"),i=i(),oe(),i),se=re(()=>m("span",{class:"tip"},"点击页面播放视频",-1)),ce={id:"video",loop:"",crossOrigin:"anonymous",playsinline:""},ie=["src"],le={__name:"TextureShader",setup(i){let v=null;const p=V(null),f=V(null),E=()=>new B,C=n=>{const e=new O(45,n,1,1e3);return e.position.set(0,0,60),e.lookAt(0,0,0),e},M=(n,e,t)=>{const o=new F({canvas:n,antialias:!0});return o.setSize(e,t),o.setPixelRatio(window.devicePixelRatio),o},U=(n,e)=>{const t=new K(n,e);return t.minDistance=6,t.maxDistance=80,t.minPolarAngle=Math.PI/4,t.maxPolarAngle=Math.PI/2*.96,t},b=n=>{const e=`
      varying vec2 vUV;
