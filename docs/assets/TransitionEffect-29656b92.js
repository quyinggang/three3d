import{O as A,ad as G,z as j,af as B,u as I,aa as N,h as n,aE as s,ag as W}from"./three.module-8f39f104.js";import{G as z}from"./dat.gui.module-5ea4ba08.js";import{_ as O,r as h,o as q,a as H,b as $,c as J,d as K}from"./index-c2a2ef43.js";const i=""+new URL("gmlei-04357529.png",import.meta.url).href,u=""+new URL("gmhuo-854cb44a.png",import.meta.url).href;const Q={__name:"TransitionEffect",setup(X){let d=null;const f=h(null),p=h(null),_=()=>new G,w=e=>{const t=new j(45,e,1,1e3);return t.position.set(0,0,2),t.lookAt(0,0,0),t},D=(e,t,r)=>{const o=new B({canvas:e,antialias:!0});return o.setSize(t,r),o.setPixelRatio(window.devicePixelRatio),o},g=()=>{const e=`
      varying vec2 vUV;
  ...
  `,r=new n;return new s({uniforms:{uTexture1:{value:r.load(i)},uTexture2:{value:r.load(u)},uTime:{value:0}},vertexShader:e,fragmentShader:t})},L=()=>{const e=g();return new I(new N(1.4,.7,1),e)},a=e=>{e.material.dispose()},C=e=>{const t=new z;t.width=100;const r={scheme1:()=>{a(e),e.material=g()},scheme2:()=>{a(e),e.material=y()},scheme3:()=>{a(e),e.material=M()},scheme4:()=>{a(e),e.material=b()},scheme5:()=>{a(e),e.material=S()},scheme6:()=>{a(e),e.material=E()}};return t.add(r,"scheme1").name("方案1"),t.add(r,"scheme2").name("方案2"),t.add(r,"scheme3").name("方案3"),t.add(r,"scheme4").name("方案4"),t.add(r,"scheme5").name("方案5"),t.add(r,"scheme6").name("方案6"),t.open(),()=>t.destroy()};return q(()=>{const e=f.value,t=p.value,r=t.clientWidth,o=t.clientHeight,m=_(),P=w(r/o),l=D(e,r,o),v=L(),R=C(v);m.add(v);const F=new W,T=()=>{const c=F.getElapsedTime();v.material.uniforms.uTime.value=c,l.render(m,P),d=window.requestAnimationFrame(T)};T(),H(()=>{R(),l.dispose(),l.forceContextLoss(),m.traverse(c=>{if(c instanceof A){const{geometry:V,material:x}=c;V&&V.dispose();const k=Array.isArray(x)?x:[x];for(const U of k)U&&U.dispose()}}),window.cancelAnimationFrame(d)})}),(e,t)=>($(),J("div",{ref_key:"containerElementRef",ref:p,class:"container"},[K("canvas",{ref_key:"canvasElementRef",ref:f},null,512)],512))}},te=O(Q,[["__scopeId","data-v-f12deed7"]]);export{te as default};
