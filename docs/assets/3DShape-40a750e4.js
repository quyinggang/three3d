import{g as x,O as P,ad as M,E as z,af as A,aE as S,aW as b,aa as T,u as k,ag as B}from"./three.module-8f39f104.js";import{_ as D,r as w,o as F,a as G,b as I,c as O,d as W}from"./index-b85de818.js";const X={__name:"3DShape",setup(Y){const l=w(null),u=w(null),_=()=>new M,h=()=>new z(-1,1,1,-1,-1,1),V=(n,c,a)=>{const e=new A({canvas:n,antialias:!0});return e.setSize(c,a),e.setPixelRatio(window.devicePixelRatio),e},y=()=>{const n=`
    void main() {
  ...
  `,a=new S({uniforms:{iResolution:{value:new x(0,0,1)},iMouse:{value:new b(0,0,0,0)},iTime:{value:0}},vertexShader:n,fragmentShader:c}),e=new T(2,2);return new k(e,a)};return F(()=>{let n=null;const c=l.value,e=u.value.getBoundingClientRect(),C=e.width,L=e.height,s=_(),j=h(),r=V(c,C,L),d=y();s.add(d);const m=r.domElement,R=new B,v=d.material.uniforms;v.iResolution.value=new x(m.width,m.height,1);const g=()=>{const t=R.getElapsedTime();v.iTime.value=t,r.render(s,j),n=window.requestAnimationFrame(g)},f=t=>{const i=t.clientX-e.left,o=t.clientY-e.top;v.iMouse.value=new b(i,o,0,0)};window.addEventListener("mousemove",f),g(),G(()=>{r.dispose(),r.forceContextLoss(),s.traverse(t=>{if(t instanceof P){const{geometry:i,material:o}=t;i&&i.dispose();const E=Array.isArray(o)?o:[o];for(const p of E)p&&p.dispose()}}),window.cancelAnimationFrame(n),window.removeEventListener("mousemove",f)})}),(n,c)=>(I(),O("div",{ref_key:"containerElementRef",ref:u,class:"container"},[W("canvas",{ref_key:"canvasElementRef",ref:l},null,512)],512))}},U=D(X,[["__scopeId","data-v-6613e4ea"]]);export{U as default};
