import{O as A,ad as P,z as b,af as F,aE as v,u as p,ah as h,C as O}from"./three.module-8f39f104.js";import{O as G}from"./OrbitControls-8206acf3.js";import{_ as L,r as w,o as V,a as W,b as j,c as z,d as q}from"./index-7c705545.js";const D={__name:"BasicShader",setup(H){let c=null;const i=w(null),l=w(null),x=()=>new P,g=n=>{const e=new b(45,n,1,1e3);return e.position.set(0,2,6),e.lookAt(0,0,0),e},C=(n,e)=>new G(n,e),S=(n,e,o)=>{const t=new F({canvas:n,antialias:!0});return t.setSize(e,o),t.setPixelRatio(window.devicePixelRatio),t},E=()=>{const n=`
    void main() {
      // 顶点坐标位置
