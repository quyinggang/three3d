import{O as P,ad as R,z as E,af as N,aE as M,C as b,u as B,aw as G}from"./three.module-8f39f104.js";import{O as k}from"./OrbitControls-8206acf3.js";import{_ as z,r as p,o as A,a as I,b as O,c as D,d as F}from"./index-b3ad2289.js";const L={__name:"InnerGlowShader",setup(V){let c=null;const i=p(null),l=p(null),_=()=>new R,w=n=>{const e=new E(45,n,1,1e3);return e.position.set(0,0,6),e.lookAt(0,0,0),e},x=(n,e,o)=>{const a=new N({canvas:n,antialias:!0});return a.setSize(e,o),a.setPixelRatio(window.devicePixelRatio),a},h=(n,e)=>{const o=new k(n,e);return o.minDistance=6,o.maxDistance=40,o},y=()=>{const n=`
