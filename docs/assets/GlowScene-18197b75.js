import{ad as O,z as A,af as V,O as W,u as v,aw as L,M as u,ah as C,G as z,V as F,aE as H}from"./three.module-b483cf05.js";import{O as I}from"./OrbitControls-3e78db25.js";import{R as E,E as M,U as N,O as g,S as q}from"./OutputPass-d4480442.js";import{_ as J,r as h,o as K,w as Q,a as X,b as Y,c as Z,d as b,t as $}from"./index-964def9b.js";const j={__name:"GlowScene",setup(ee){const x=h(null),_=h(null),d=h(0),P=(o,t,s,n=!0)=>{const c=new E(o,t),a=new M(s),r=new N(new F(window.innerWidth/2,window.innerHeight/2),1.5,.4,.85);if(r.threshold=0,r.strength=.55,r.radius=0,a.addPass(c),a.addPass(r),n){const i=new g;a.addPass(i)}else a.renderToScreen=!1;return a},G=(o,t,s,n)=>{const c=new E(o,t),a=new g,r=new q(new H({uniforms:{baseTexture:{value:null},bloomTexture:{value:n.renderTarget2.texture}},vertexShader:`
        varying vec2 vUv;
