import{O as S,ad as R,z as M,af as b,aE as k,C as r,u as A,ah as B}from"./three.module-b483cf05.js";import{O as z}from"./OrbitControls-3e78db25.js";import{_ as O,r as _,o as P,a as D,b as F,c as G,d as L}from"./index-964def9b.js";const W={__name:"NormalShader",setup(V){let i=null;const l=_(null),d=_(null),w=()=>new R,p=n=>{const e=new M(45,n,1,1e3);return e.position.set(3,3,3),e.lookAt(0,0,0),e},h=(n,e,o)=>{const a=new b({canvas:n,antialias:!0});return a.setSize(e,o),a.setPixelRatio(window.devicePixelRatio),a},N=(n,e)=>{const o=new z(n,e);return o.minDistance=2,o.maxDistance=40,o},y=()=>{const n=`
