import{g as _,O as I,ad as T,E as z,af as P,aE as b,aW as y,aa as L,u as N,ag as X}from"./three.module-8787a522.js";import{_ as D,r as w,o as F,a as V,b as B,c as O,d as H}from"./index-1a0b05a6.js";const U={__name:"ShapeColor",setup(G){const v=w(null),u=w(null),S=()=>new T,C=()=>new z(-1,1,1,-1,-1,1),E=(o,r,t)=>{const e=new P({canvas:o,antialias:!0});return e.setSize(r,t),e.setPixelRatio(window.devicePixelRatio),e},k=()=>{const o=`
    void main() {
