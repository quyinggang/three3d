import{g,O as k,ad as B,E as L,af as P,aE as A,aW as p,aa as F,u as V,ag as G}from"./three.module-8f39f104.js";import{_ as I,r as h,o as O,a as W,b as j,c as q,d as z}from"./index-b85de818.js";const D={__name:"ShaderToy",setup(N){const m=h(null),d=h(null),y=()=>new B,x=()=>new L(-1,1,1,-1,-1,1),E=(n,a,r)=>{const e=new P({canvas:n,antialias:!0});return e.setSize(a,r),e.setPixelRatio(window.devicePixelRatio),e},R=()=>{const n=`
    void main() {
