import{g as h,O as k,ad as B,E as P,af as b,aE as A,aW as E,aa as F,u as V,ag as G}from"./three.module-8787a522.js";import{_ as I,r as y,o as O,a as W,b as D,c as U,d as j}from"./index-34a60af4.js";const q={__name:"ShaderToy",setup(z){const u=y(null),v=y(null),x=()=>new B,R=()=>new P(-1,1,1,-1,-1,1),C=(n,o,t)=>{const e=new b({canvas:n,antialias:!0});return e.setSize(o,t),e.setPixelRatio(window.devicePixelRatio),e},M=()=>{const n=`
    void main() {
