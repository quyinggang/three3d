import{g as _,O as I,ad as T,E as z,af as P,aE as L,aW as y,aa as N,u as X,ag as b}from"./three.module-8f39f104.js";import{_ as D,r as w,o as F,a as V,b as B,c as O,d as H}from"./index-7c705545.js";const U={__name:"ShapeColor",setup(G){const v=w(null),u=w(null),S=()=>new T,C=()=>new z(-1,1,1,-1,-1,1),E=(o,r,t)=>{const e=new P({canvas:o,antialias:!0});return e.setSize(r,t),e.setPixelRatio(window.devicePixelRatio),e},k=()=>{const o=`
    void main() {
  ...
  `,t=new L({uniforms:{iResolution:{value:new _(0,0,1)},iMouse:{value:new y(0,0,0,0)},iTime:{value:0}},vertexShader:o,fragmentShader:r}),e=new N(2,2);return new X(e,t)},M=(o,r,t)=>{let e=!1;const c=n=>{if(!e)return;const l=n.clientX-r.left,a=n.clientY-r.top;t.iMouse.value=new y(l,a,0,0)},s=()=>{e=!1,window.removeEventListener("mousemove",c),window.removeEventListener("mouseup",s)};o.addEventListener("mousedown",()=>{e=!0,window.addEventListener("mousemove",c),window.addEventListener("mouseup",s)})};return F(()=>{let o=null;const r=v.value,t=u.value,e=t.getBoundingClientRect(),c=e.width,s=e.height,n=S(),l=C(),a=E(r,c,s),p=k();n.add(p);const f=a.domElement,A=new b,d=p.material.uniforms;d.iResolution.value=new _(f.width,f.height,1);const h=()=>{const i=A.getElapsedTime();d.iTime.value=i,a.render(n,l),o=window.requestAnimationFrame(h)};M(t,e,d),h(),V(()=>{a.dispose(),a.forceContextLoss(),n.traverse(i=>{if(i instanceof I){const{geometry:g,material:m}=i;g&&g.dispose();const R=Array.isArray(m)?m:[m];for(const x of R)x&&x.dispose()}}),window.cancelAnimationFrame(o)})}),(o,r)=>(B(),O("div",{ref_key:"containerElementRef",ref:u,class:"container"},[H("canvas",{ref_key:"canvasElementRef",ref:v},null,512)],512))}},q=D(U,[["__scopeId","data-v-7512002a"]]);export{q as default};
