import{g as h,O as M,ad as P,E as z,af as A,aE as S,aW as b,aa as T,u as k,ag as B}from"./three.module-8787a522.js";import{_ as D,r as _,o as F,a as G,b as I,c as O,d as W}from"./index-2f68f5e3.js";const Y={__name:"DepthShape",setup(U){const d=_(null),m=_(null),L=()=>new P,V=()=>new z(-1,1,1,-1,-1,1),y=(n,t,c)=>{const e=new A({canvas:n,antialias:!0});return e.setSize(t,c),e.setPixelRatio(window.devicePixelRatio),e},C=()=>{const n=`
    void main() {
