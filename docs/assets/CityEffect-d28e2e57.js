import{O as D,ad as M,z,af as k,G as x,ar as G,D as H,o as I,v as O,as as U,C as l,ag as W}from"./three.module-8f39f104.js";import{O as X}from"./OrbitControls-8206acf3.js";import{F as q,s as V}from"./shanghai-1e34c267.js";import{_ as Y,r as w,o as $,a as j,b as J,c as K,d as Q}from"./index-b85de818.js";const Z={__name:"CityEffect",setup(ee){let v=null;const g=w(null),S=w(null),C=()=>new M,y=e=>{const o=new z(45,e,1,1e4);return o.position.set(0,50,1e3),o.lookAt(0,0,0),o},T=(e,o,t)=>{const a=new k({canvas:e,antialias:!0});return a.setSize(o,t),a.setPixelRatio(window.devicePixelRatio),a},P=(e,o)=>{const t=new X(e,o);return t.enableDamping=!0,t.minDistance=300,t.maxDistance=6e3,t.minPolarAngle=Math.PI/4,t.maxPolarAngle=Math.PI/2*.96,t},E=()=>{const e=new x,o=new G(11382189),t=new H(16777215,.5);return t.position.set(600,600,0),e.add(o),e.add(t),e},R=e=>{new q().load(V,t=>{e&&e(t)})},m=[],h=e=>{e.uniforms.uProgress={value:0},e.vertexShader=`
