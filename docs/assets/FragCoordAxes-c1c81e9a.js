import{g as _,O as L,ad as A,E as F,af as k,aE as B,aW as h,aa as P,u as T,ag as V}from"./three.module-b483cf05.js";import{_ as G,r as y,o as I,a as O,b as W,c as D,d as U}from"./index-964def9b.js";const X={__name:"FragCoordAxes",setup(j){const m=y(null),v=y(null),E=()=>new A,R=()=>new F(-1,1,1,-1,-1,1),C=(o,n,t)=>{const e=new k({canvas:o,antialias:!0});return e.setSize(n,t),e.setPixelRatio(window.devicePixelRatio),e},M=()=>{const o=`
    void main() {
