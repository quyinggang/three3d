import{O as W,ad as L,z as H,af as q,aE as s,C as i,u as l,aa as c,ag as z}from"./three.module-8787a522.js";import{_ as D,r as R,o as j,a as B,b as G,c as O,d as I}from"./index-34a60af4.js";const N={__name:"TransformShader",setup(J){let u=null;const d=R(null),v=R(null),y=()=>new L,k=o=>{const t=new H(45,o,1,1e3);return t.position.set(0,0,10),t.lookAt(0,0,0),t},F=(o,t,a)=>{const e=new q({canvas:o,antialias:!0});return e.setSize(t,a),e.setPixelRatio(window.devicePixelRatio),e},T=()=>{const o=`
      varying vec2 vUV;
