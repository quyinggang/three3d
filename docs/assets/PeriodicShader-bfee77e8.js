import{O as B,ad as G,z as O,af as z,aE as w,C as h,u as x,ah as D,aa as L,ag as U}from"./three.module-8787a522.js";import{O as V}from"./OrbitControls-8109a5ff.js";import{_ as W,r as g,o as j,a as q,b as H,c as I,d as N}from"./index-2f68f5e3.js";const T={__name:"PeriodicShader",setup(J){let m=null;const d=g(null),f=g(null),C=()=>new G,y=o=>{const e=new O(45,o,1,1e3);return e.position.set(0,0,8),e.lookAt(0,0,0),e},P=(o,e,n)=>{const t=new z({canvas:o,antialias:!0});return t.setSize(e,n),t.setPixelRatio(window.devicePixelRatio),t},S=(o,e)=>{const n=new V(o,e);return n.minDistance=3,n.maxDistance=40,n},E=()=>{const o=`
			void main() {
