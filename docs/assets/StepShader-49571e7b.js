import{O as R,ad as A,z as O,af as b,aE as h,C as s,q as k,u as _,ah as w}from"./three.module-8f39f104.js";import{O as B}from"./OrbitControls-8206acf3.js";import{_ as D,r as S,o as G,a as I,b as L,c as W,d as j}from"./index-16e2df25.js";const q={__name:"StepShader",setup(z){let c=null;const l=S(null),m=S(null),g=()=>new A,C=o=>{const e=new O(45,o,1,1e3);return e.position.set(0,0,6),e.lookAt(0,0,0),e},x=(o,e,t)=>{const n=new b({canvas:o,antialias:!0});return n.setSize(e,t),n.setPixelRatio(window.devicePixelRatio),n},E=(o,e)=>{const t=new B(o,e);return t.minDistance=6,t.maxDistance=40,t.minPolarAngle=Math.PI/4,t.maxPolarAngle=Math.PI/2*.96,t},P=()=>{const o=`
      varying vec2 vUV;
		  void main() {
        vUV = uv;
