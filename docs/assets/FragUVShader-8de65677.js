import{O as B,ad as D,z as P,af as b,aE as p,C as _,q as h,u as g,aa as w,V as k}from"./three.module-8f39f104.js";import{O}from"./OrbitControls-8206acf3.js";import{_ as G,r as x,o as L,a as W,b as j,c as q,d as z}from"./index-dafdd258.js";const H={__name:"FragUVShader",setup(I){let i=null;const l=x(null),u=x(null),y=()=>new D,C=e=>{const t=new P(45,e,1,1e3);return t.position.set(0,0,4),t.lookAt(0,0,0),t},R=(e,t,n)=>{const o=new b({canvas:e,antialias:!0});return o.setSize(t,n),o.setPixelRatio(window.devicePixelRatio),o},S=(e,t)=>{const n=new O(e,t);return n.minDistance=6,n.maxDistance=40,n},V=()=>{const e=`
      varying vec2 vUV;
