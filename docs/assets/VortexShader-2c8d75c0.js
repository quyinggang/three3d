import{O as b,ad as B,z as D,af as G,aE as i,C as u,u as s,aa as c,h as W,ag as z}from"./three.module-8787a522.js";import{_ as O,r as U,o as q,a as H,b as N,c as J,d as K}from"./index-1a0b05a6.js";const Q=""+new URL("color-59f07015.jpg",import.meta.url).href;const X={__name:"VortexShader",setup(Y){let v=null;const d=U(null),f=U(null),T=()=>new B,C=o=>{const t=new D(45,o,1,1e3);return t.position.set(0,0,6),t.lookAt(0,0,0),t},y=(o,t,n)=>{const e=new G({canvas:o,antialias:!0});return e.setSize(t,n),e.setPixelRatio(window.devicePixelRatio),e},F=()=>{const o=`
      varying vec2 vUV;
