import{O as S,ad as b,z as C,af as F,aE as M,V as k,u as A,ah as B}from"./three.module-8f39f104.js";import{O}from"./OrbitControls-8206acf3.js";import{_ as P,r as f,o as V,a as G,b as L,c as W,d as z}from"./index-180ee8ed.js";const j={__name:"FragShader",setup(q){let i=null;const l=f(null),m=f(null),h=()=>new b,p=e=>{const n=new C(45,e,1,1e3);return n.position.set(0,2,6),n.lookAt(0,0,0),n},w=(e,n)=>new O(e,n),g=(e,n,o)=>{const t=new F({canvas:e,antialias:!0});return t.setSize(n,o),t.setPixelRatio(window.devicePixelRatio),t},x=(e,n)=>{const o=`
    void main() {
